    ...
    container.innerHTML = `
        <h4 class="titles" style="color:darkorange"><b>Comprobar resultados</b></h4>
         ...
         <section id="comprobar" class="content-section">
            <h3 style="color:darkorange"><em><b>Resolución de ejercicios con IA Generativa</b></em></h3>
            <div>
                <p>
            ...
            <div class="resultsDiv">
                <div>
                    <h5 style="color:darkorange"><b><em>Resultado 1-</b> Prompt nºX (habitual)</em></h5>
                    <div class="promptText">
                        <p>LALALALALA</p>
                    </div>
                </div>
                <div>
                    <h5 style="color:darkorange"><b><em>Resultado 2 -</b> Prompt nºX (mejorado)</em></h5>
